...
public final class FlowCore {
    ...
    public static final String PREF="bubble_filter_best1_v18";
    public static final String ACTION_UPDATED="com.bubbleladder.filterbest1v18.FLOW_UPDATED";
    ...
    public static SyncResult sync(Context c)throws Exception{
        ...
        try{
            ...
            stage="삼치기 필터 + 최종 1픽"; sp.edit().putString(K_LAST_STAGE,stage).apply(); Analysis a=analyze(merged);
    ...
    public static Analysis analyze(List<Result> desc){
        ...
        try{a.tri80=TriPick80Engine.optimize(all);}catch(Throwable e){a.tri80=new TriPick80Engine.Result();a.tri80.detail="삼치기80 엔진 보호모드 · "+safeErr(e);}
    ...
    private static void savePending(Context c,List<Result>d,Analysis a){
        ...
        // V1.8: 1차 삼치기는 필터로만 쓰고, 실제 저장/채점 대상은 남은 3개 중 최종 1픽 하나다.
    ...
    public static JSONObject backup(Context c)throws Exception{
        SharedPreferences sp=prefs(c); JSONObject root=new JSONObject(); root.put("format","BubbleFilterBest1V18Backup");
