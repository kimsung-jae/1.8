...
public class AutoDrawService extends Service{
    public static final String CHANNEL_ID="bubble_filter_best1_v18_live";
    ...
    private void createChannel(){
        if(Build.VERSION.SDK_INT>=26){
            NotificationChannel ch=new NotificationChannel(CHANNEL_ID,"FILTER FINAL V1.8 자동추첨",NotificationManager.IMPORTANCE_LOW);
            ch.setDescription("보글사다리 삼치기 필터 후 최종 1픽과 다음 추첨 시간을 표시합니다.");
    ...
    private Notification buildNotification(){
        ...
        return b.setSmallIcon(android.R.drawable.ic_popup_sync)
                .setContentTitle("보글사다리 FILTER FINAL 1PICK V1.8 · 백그라운드 ON")
                .setContentText(text)
