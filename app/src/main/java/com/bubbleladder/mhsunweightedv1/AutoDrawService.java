...
public class AutoDrawService extends Service{
    ...
    private void createChannel(){
        if(Build.VERSION.SDK_INT>=26){
            NotificationChannel ch=new NotificationChannel(CHANNEL_ID,"삼치기80 30FIX 자동추첨",NotificationManager.IMPORTANCE_LOW);
            ch.setDescription("보글사다리 삼치기80 30FIX 픽과 다음 추첨 시간을 표시합니다.");
    ...
    private Notification buildNotification(){
        ...
        String text="다음 "+FlowCore.countdownText()+" · 30FIX "+pick+" · 실전 "+FlowCore.liveRate(this);
        Notification.Builder b=Build.VERSION.SDK_INT>=26?new Notification.Builder(this,CHANNEL_ID):new Notification.Builder(this);
        return b.setSmallIcon(android.R.drawable.ic_popup_sync)
                .setContentTitle("보글사다리 삼치기80 30FIX · 백그라운드 ON")
                .setContentText(text)
